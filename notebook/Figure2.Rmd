...
DotPlot(Immune.Cells.TrueV2, assay = "RNA", features = c("CD3D", "CD8A", "IL7R", "KLRG1", "GZMB", "PRF1", "PDCD1", "CTLA4", "TIGIT", "CD4", "GATA3","RORC", "IL17A","IL17F", "MS4A1", "CD79A", "CD27", "CD38", "SDC1", "JCHAIN", "CD68", "HLA-DRA", "IL18", "CD163", "IL10", "VEGFA", "KIT", "TPSB2", "FCGR3A", "NCAM1"), group.by = "Immune_Cluster_ID") + labs(title = "Identifying  cell TrueV2 Sub-cluster by Canonical Markers res0.6") +
 theme_classic(base_size = 20) +
