...
DotPlot(Immune.Cells.TrueV2_sel, group.by = "Immune_Cluster_ID", features = c("PDCD1", "CTLA4", "TIGIT", "HAVCR2", "VSIR", "LAG3")) + 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")

DotPlot(Immune.Cells.TrueV2_sel, group.by = "Immune_Cluster_ID", features = c("CD80", "CD86", "CD274", "PDCD1LG2", "PVR")) + 
  theme_classic(base_size = 25) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")
...
DotPlot(d10x.seurat_Sel, group.by = "Master_Assigned_Cell_Type", features = c("CD80", "CD86", "CD274", "PDCD1LG2", "PVR")) + 
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8, color = "black"), axis.text.y = element_text(size = 15, colour = "black")) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")
```
...
DotPlot(Immune.Cells.TrueV2, group.by = "Immune_Cluster_ID", features = c("CD74", "CD44", "CXCR2", "CXCR4", "ACKR3")) + 
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8), axis.text.y = element_text(size = 15)) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")
...
Immune.Cells.TrueV2_sel <- subset(Immune.Cells.TrueV2, subset = Parent_immune_cluster %in% "B cells")
...
DotPlot(Immune.Cells.TrueV2_sel, group.by = "Class", features = selected.features[c(1:5,11,14,15,23,24,27,29:33,36,37,39,40,42:48)]) + 
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8, colour = "black"), axis.text.y = element_text(size = 12, colour = "black")) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")
...
DotPlot(d10x.seurat_Sel, group.by = "Master_Assigned_Cell_Type", features = c("TNFSF13B", "TNFSF13", "CXCL13", "CCL21", "CXCL12", "MIF", "CCL19", "CCL20", "CCL25", "CCL28")) + 
  theme_classic(base_size = 20) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")
...
p1 <-DotPlot(Immune.Cells.TrueV2_sel, assay = "RNA", features = selected.features[28:40], group.by = "Class") + labs(title = "Mac cells receptors in Endometriosis lesions") +
 theme_classic(base_size = 25) +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 0.8, size = 20, colour = "black"), axis.text.y = element_text(size = 15, colour = "black")) +
  coord_flip() +
  scale_colour_gradient2(low = "#2166ac", mid = "#f7f7f7", high = "#b2182b")
...
p1 <- DimPlot(object = Endometriosis, pt.size = 0.1,split.by = "LA_Status", group.by ="Parent_immune_cluster", label = T, raster=FALSE) +
  theme_classic(base_size = 20)  ##this is a umap with the clusters grouped with their cell identity
