...
#Sanky plot to compare resolution of 0.4 to resolution of 0.6
```{r}
#Sankey
data = as.data.frame.matrix(table(Immune.Cells.TrueV2@meta.data, B.cells.subclustering@meta.data$seurat_clusters))
data
library(networkD3)
library(dplyr)
library(tidyverse)
