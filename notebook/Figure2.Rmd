...
Endometriosis@meta.data$Immune_Cluster_ID <- factor(Endometriosis@meta.data$Immune_Cluster_ID, 
...
counts.prop = data.frame(table(Endometriosis@meta.data$Stage, Endometriosis@meta.data$Immune_Cluster_ID))
counts.prop.perc = group_by(counts.prop, Var2) %>% mutate(percent = Freq/sum(Freq))
head(counts.prop.perc)
aux = aggregate(counts.prop$Freq, by=list(Category=counts.prop$Var1), FUN=sum)
aux$Var2 = "Total"
...
Endometriosis@meta.data <- Endometriosis@meta.data  %>%
...
counts.prop = data.frame(table(Endometriosis@meta.data$Stage_Group, Endometriosis@meta.data$Immune_Cluster_ID))
counts.prop.perc = group_by(counts.prop, Var2) %>% mutate(percent = Freq/sum(Freq))
head(counts.prop.perc)
aux = aggregate(counts.prop$Freq, by=list(Category=counts.prop$Var1), FUN=sum)
aux$Var2 = "Total"
