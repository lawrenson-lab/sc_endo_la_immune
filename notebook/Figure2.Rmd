...
Immune.Cells.TrueV2@meta.data <- Immune.Cells.TrueV2@meta.data  %>%
                    mutate(Immune_Cluster_ID = case_when( 
                             ...
                             seurat_clusters == 1 ~ "Effector Memmory CD8",
                             ...
                             seurat_clusters == 6 ~ "Central Memmory CD8 T-cells (1)",
                             seurat_clusters == 7 ~ "Th2 T-cells",
                             seurat_clusters %in% c(9,12) ~ "Central Memmory CD8 T-cells (2)",
                             ...
                             seurat_clusters == 23 ~ "Central Memory CD8 T-cells"))
